...
iguais1:
    mov eax, 1 ; Definir eax como 1 caso sejam iguais
    ret
iguais2:
    mov eax, 2 ; Definir eax como 1 caso sejam iguais
    ret 
iguais3:
    mov eax, 3 ; Definir eax como 1 caso sejam iguais
    ret
...
main:
  ...
  cmp eax, 2 ; Se for >= 2
  jge triangulo_isosceles ; o Triangulo é isosceles
  call triangulo_escaleno ; se não, é escaleno
